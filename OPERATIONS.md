...
- 被災者・被災事業者向けの制度は、受付状況、金額、期限、対象条件、必要書類、先に進めると対象外になる条件を確認する。
- 受付期間が終わったもの（例: 熊本県義援金は10/30予定）は期限翌週までに整理する。
- 終了した制度を履歴として残す場合は、現在受付中の窓口と混同しないよう「終了した支援」に移す。
...
- 受付終了の反映後は、対応済みの項目を `DEADLINES` から削除し、定点確認が不要なら `WEEKLY` からも外します。
